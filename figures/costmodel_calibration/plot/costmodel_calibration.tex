...
%Axis Labels
    ...
    ylabel = {\% of Manuf. Cost \\ \textit{U.S. DoE SSL Rep.}},
	xticklabels={,,},
...
%Note: use the postaction command to hatch, otherwise, the hatch colors will overlap
%Projections
\addplot [ybar,postaction={pattern=north east lines,pattern color=green}]
	table [col sep=comma, x=year, y=wafer]
	{../data/cost_high_relative_projection.csv};
\addplot [ybar,postaction={pattern=north east lines,pattern color=red}]
	table [col sep=comma, x=year, y=epi]
	{../data/cost_high_relative_projection.csv};
\addplot [ybar,postaction={pattern=north east lines,pattern color=blue}]
	table [col sep=comma, x=year, y=subst]
	{../data/cost_high_relative_projection.csv};
\addplot [ybar,postaction={pattern=north east lines,pattern color=violet}]
	table [col sep=comma, x=year, y=phos]
	{../data/cost_high_relative_projection.csv};
\addplot [ybar,postaction={pattern=north east lines,pattern color=cyan}]
...
%Axis Labels
    ylabel style={align=center},
    ylabel = {\% of Manuf. Cost \\ \textit{US DoE SSL Rep.}},
	xticklabels={,,},
	yticklabels={,,20,40,60,80,100},
	/pgf/number format/1000 sep={},
%Legend
...
%Axis Labels
    ylabel style={align=center},
    ylabel = {\% of Manuf. Cost \\ \textit{Cost Model}},
	%xticklabels={,,},
	/pgf/number format/1000 sep={},
]
\addplot [ybar,fill=green!20,draw=black!70]
