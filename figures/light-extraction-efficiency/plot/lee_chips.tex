...
%Axis labels
	ylabel style = {align=center},
	ylabel={LEE [\%]} \\ {Thin-Film Flip-Chip},
%Legend
...
%Axis labels
	...
	/pgf/number format/1000 sep={},
%Legend
	legend entries={Simulation, Experiment Direct, Experiment Estimated},
	legend cell align={left},
	legend pos=south east,
	legend style={draw=none},
]
\addplot [black, only marks, mark=o,mark options={scale=2}] table [col sep=comma, x=year, y=lee]{../data/classical_simulated.csv};
\addplot [black, only marks, mark=square,mark options={scale=2}] table [col sep=comma, x=year, y=lee]{../data/classical_direct.csv};
\addplot [black, only marks, mark=triangle,mark options={scale=2}] table [col sep=comma, x=year, y=lee]{../data/classical_estimated.csv};
\end{axis}
...
\addplot [orange, only marks, mark=diamond] table [col sep=comma, x=year, y=lee]{../data/thin_pss.csv};
\addplot [orange, only marks, mark=pentagon*] table [col sep=comma, x=year, y=lee]{../data/thin_micro.csv};
\addplot [black, only marks, mark=o,mark options={scale=2}] table [col sep=comma, x=year, y=lee]{../data/thin_simulated.csv};
\addplot [black, only marks, mark=square,mark options={scale=2}] table [col sep=comma, x=year, y=lee]{../data/thin_direct.csv};
\addplot [black, only marks, mark=triangle,mark options={scale=2}] table [col sep=comma, x=year, y=lee]{../data/thin_estimated.csv};
\end{axis}
...
\addplot [blue, only marks, mark=diamond] table [col sep=comma, x=year, y=lee]{../data/flip_pss.csv};
\addplot [blue, only marks, mark=triangle] table [col sep=comma, x=year, y=lee]{../data/flip_mirror.csv};
\addplot [black, only marks, mark=o,mark options={scale=2}] table [col sep=comma, x=year, y=lee]{../data/flip_simulated.csv};
\addplot [black, only marks, mark=square,mark options={scale=2}] table [col sep=comma, x=year, y=lee]{../data/flip_direct.csv};
\addplot [black, only marks, mark=triangle,mark options={scale=2}] table [col sep=comma, x=year, y=lee]{../data/flip_estimated.csv};
\end{axis}
