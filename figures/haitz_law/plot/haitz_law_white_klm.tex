...
\addplot [only marks]
	...
	{../data/white_flux.csv};
%Chip Number
\addplot [black, only marks, mark=triangle,mark size=5pt] table [col sep=comma, x=year, y=flux]{../data/white_flux_1chip.csv};
...
\addplot [black, only marks, mark=square,mark size=4pt] table [col sep=comma, x=year, y=flux]{../data/white_flux_multichip.csv};
%Annotations
