...
\node[draw=black,anchor=west,align=right] at (canvas cs:x=20pt,y=20pt) {Percentages indicate losses of remaining energy at point of loss channel. Absolute losses in W below. \\ Percentages for \textcolor{red}{red}, \textcolor{teal}{green} and \textcolor{blue}{blue} loss channels indicate losses of remaining \textcolor{red}{R}/\textcolor{teal}{G}/\textcolor{blue}{B} light energy.};
\end{axis}
