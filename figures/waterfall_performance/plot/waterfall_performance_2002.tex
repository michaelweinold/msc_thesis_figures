...
\node [above right] at (rel axis cs:0.58,0.7) {\includegraphics[width=2.5cm]{../data/package/2002_chip.pdf}};
\end{axis}
...
\addplot []
	...
	{../data/phosphor/2002_lumileds_ygag.csv};
\end{axis}
