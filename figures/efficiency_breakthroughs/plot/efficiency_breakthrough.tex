...
%Axis Labels
	...
	xticklabels={,V$_\text{f}$E, IQE, Droop, LEE, CE \\ (\textcolor{red}{Red}), CE \\ (\textcolor{teal}{Green}/\textcolor{orange}{Yellow}), SE, \textbf{PCE}},
%Legend
...
\draw[->, blue, thick] (axis cs:0,103) -- (axis cs:0,107);
%IQE
\draw [teal, thick] (axis cs:0.75,40) -- (axis cs:1.25,40);
...
%CE(Green/Yellow)
\draw [orange, thick] (axis cs:4.75,65) -- (axis cs:5.25,65);
